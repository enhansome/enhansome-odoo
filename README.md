...
Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,318 | 🐛 20 | 🌐 Python | 📅 2026-09-22.
...
* [Odoo Community](https://github.com/odoo/odoo) ⭐ 54,519 | 🐛 10,471 | 🌐 Python | 📅 2026-09-22 - Community Official Repositories
* [Odoo OWL web framework](https://github.com/odoo/owl) ⭐ 1,585 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-11 - OWL web framework Official Repositories
* [Odoo Documentation](https://github.com/odoo/documentation) ⭐ 1,334 | 🐛 327 | 🌐 reStructuredText | 📅 2026-09-22 - Documentation Official Repositories
...
* [Sunpop App Odoo](https://github.com/guohuadeng/app-odoo) ⭐ 457 | 🐛 3 | 🌐 HTML | 📅 2026-09-22 - Repository with modules for all versions by sunpop
* [Odoo Design Themes](https://github.com/odoo/design-themes) ⭐ 201 | 🐛 34 | 🌐 SCSS | 📅 2026-09-22 - Design Themes Official Repositories
...
* All-in-one tools
  * [Doodba](https://github.com/tecnativa/doodba) ⭐ 548 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-22 - Base (docker) image for making the creation of customized Odoo environments a piece of cake.
...
* Script
  * [Odoo Install Script](https://github.com/Yenthe666/InstallScript) ⭐ 1,436 | 🐛 69 | 🌐 Shell | 📅 2026-09-20 - Install Script by Yenthe Van Ginneken
...
* Ides
  * [Spacemacs](https://github.com/syl20bnr/spacemacs) ⭐ 24,559 | 🐛 64 | 🌐 Emacs Lisp | 📅 2026-09-22 - A editor that combines Emacs with Vim
...
* CLI
  * [click-odoo-contrib](https://github.com/acsone/click-odoo-contrib) ⭐ 158 | 🐛 37 | 🌐 Python | 📅 2026-09-21 - Useful scripts and utility functions, based on click-odoo
  * [click-odoo](https://github.com/acsone/click-odoo) ⭐ 148 | 🐛 9 | 🌐 Python | 📅 2026-09-21 - Run python scripts in a Odoo environment

* Linters
  * [pylint-odoo](https://github.com/OCA/pylint-odoo) ⭐ 172 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - Pylint plugin
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/desdelinux/awesome-odoo/blob/master/CONTRIBUTING.md) ⭐ 428 | 🐛 7 | 📅 2025-10-22 first.
